...
class AddPlanDevis extends Component{
    ...
    handleSubmit = (event)=>{
        ...
        data.append("grosoeuvre", this.grosOeuvreFile.current.files[0], this.grosOeuvreFile.current.files[0].name)
        data.append("secondoeuvre", this.secondOeuvreFile.current.files[0], this.secondOeuvreFile.current.files[0].name)
        data.append("charpentetoiture", this.charpenteToitureFile.current.files[0], this.charpenteToitureFile.current.files[0].name)
        data.append("data", JSON.stringify(this.state))
        let action = "failure"
        axios
            .post("/api/addplandevis", data, {onUploadProgress: ProgressEvent =>{
        ...
        return (
            <React.Fragment>
                ...
                <div className="container-fluid text-center">
                    ...
                    <h1>Formulaire d'ajout d'un plan de D&eacute;vis</h1>
                    <form action="#" onSubmit={this.handleSubmit}>
                        ...
                        <div className="form-group">
                            <label for="grosoeuvre">Gros oeuvre :&nbsp; 
                                <input type="file" id="grosoeuvre" ref={this.grosOeuvreFile} required/>
                            </label>
                        </div>
                        <div className="form-group">
                            <label for="secondoeuvre">Second Oeuvre :&nbsp; 
                                <input type="file" id="secondoeuvre" ref={this.secondOeuvreFile} required/>
                            </label>
                        </div>
                        <div className="form-group">
                            <label for="charpentetoiture">Charpente et toîture :&nbsp; 
                                <input type="file" id="charpentetoiture" ref={this.charpenteToitureFile} required/>
                            </label>
                        </div>
                        <div className="form-group">
